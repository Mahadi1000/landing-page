      ...
      <div className="self-stretch relative flex flex-col justify-center items-center gap-2 py-0">
        <div className="flex flex-col justify-start items-center gap-4">
          <h2 className="text-center text-foreground text-3xl md:text-4xl lg:text-[40px] font-semibold leading-tight md:leading-tight lg:leading-[40px]">
            <span className="text-gradient">Coding made effortless</span>
          </h2>
...
const TestimonialCard = ({
  ...
  const avatarBorderRadius = isLargeCard ? 48 : 36;
  const padding = isLargeCard ? "p-6" : "p-[30px]";
  let cardClasses = `flex flex-col justify-between items-start overflow-hidden rounded-[10px] shadow-[0px_2px_4px_rgba(0,0,0,0.08)] relative ${padding} cursor-pointer`;
  let quoteClasses = "";
  let nameClasses = "";
  let companyClasses = "";
      ...
      <div className="relative z-10 flex justify-start items-center gap-3">
        <Image
          ...
          className={`w-${avatarSize / 4} h-${
            avatarSize / 4
          } ${avatarBorderRadius} border-none`}
        />
