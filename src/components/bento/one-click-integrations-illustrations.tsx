...
> = ({ className = "" }) => {
  const themeVars = {
    "--oci-primary-color": "oklch(var(--primary))",
    "--oci-background-color": "oklch(var(--background))",
    "--oci-foreground-color": "oklch(var(--foreground))",
    "--oci-muted-foreground-color": "oklch(var(--muted-foreground))",
    "--oci-border-color": "oklch(var(--border))",
    "--oci-shadow-color": "rgba(0, 0, 0, 0.12)",
    "--oci-gradient-light-gray-start": "oklch(var(--foreground) / 0.2)",
  ...
  const LogoBox: React.FC<{
    ...
    const boxStyle: React.CSSProperties = {
      ...
      position: "relative",
      borderRadius: "9px",
      border: `1px var(--oci-border-color) solid`,
      display: "flex",
