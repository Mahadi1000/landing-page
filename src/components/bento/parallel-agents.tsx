...
const ParallelCodingAgents: React.FC<ParallelCodingAgentsProps> = ({
  ...
  const themeVars = {
    "--pca-background-color": "oklch(var(--background))",
    "--pca-background-glass": "oklch(var(--card) / 0.2)",
    "--pca-background-gradient-start": "oklch(var(--card) / 0.2)",
    "--pca-background-gradient-end": "transparent",
    "--pca-text-primary": "oklch(var(--foreground))",
    "--pca-text-secondary": "oklch(var(--muted-foreground))",
    "--pca-border-color": "oklch(var(--border))",
    "--pca-border-main": "oklch(var(--border))",
    "--pca-shadow-color": "rgba(0, 0, 0, 0.12)", // Keeping as is, common shadow
    "--pca-container-background": "oklch(var(--card) / 0.4)",
    "--pca-container-gradient-start": "oklch(var(--card) / 0.4)",
    ...
    >
      ...
      <div
        style={{
          ...
          background:
            "linear-gradient(180deg, oklch(var(--primary) / 0.05) 0%, transparent 100%)", // Updated background property
          backdropFilter: "blur(16px)",
          borderRadius: "9.628px",
          border: "0.802px solid oklch(var(--border))",
          overflow: "hidden",
          boxSizing: "border-box",
