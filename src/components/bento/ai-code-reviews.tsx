...
const AiCodeReviews: React.FC = () => {
  const themeVars = {
    "--ai-primary-color": "oklch(var(--primary))",
    "--ai-background-color": "oklch(var(--background))",
    "--ai-text-color": "oklch(var(--foreground))",
    "--ai-text-dark": "oklch(var(--primary-foreground))",
    "--ai-border-color": "oklch(var(--border))",
    "--ai-border-main": "oklch(var(--foreground) / 0.1)",
    "--ai-highlight-primary": "oklch(var(--primary) / 0.12)",
    "--ai-highlight-header": "oklch(var(--accent) / 0.2)",
  };
